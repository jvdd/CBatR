...
public final class DomainConstants {
	...
	// It's just a container for some global knowledge, given by the guy who created the real-life DeltaIoT system
	private DomainConstants() {} 
	
	private static final double[] powerConsumptionRate = 
		{ 20.2, 21.2, 22.3, 23.7, 24.7, 26.1, 27.5, 28.8, 30.0, 31.2, 32.4, 33.7, 35.1, 36.5, 38.0, 38.9 };
