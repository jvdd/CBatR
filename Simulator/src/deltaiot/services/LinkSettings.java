...
public class LinkSettings {
	private int src;
	private int dest;
	private int powerSettings=-4;
	private int distributionFactor=-1;
	private int spreadingFactor=0;
	...
	public String toString() {
		return String.format("src=%d,dest=%d,powerSettings=%d,distributionFactor=%d,spreadingFactor=%d", src, dest, powerSettings, distributionFactor, spreadingFactor);
	}
}
